...
var listen = function listen(obj, event, callback) {
  obj = typeof obj === "string" ? select(obj) : obj;
  obj.addEventListener(event, callback);
};

var listenAll = function listenAll(objs, event, callback) {
...
function toggleAside(el, i) {
  var aside = asides[i]; //   el.addEventListener("click", function () {
  //     var aside = asides[i];
